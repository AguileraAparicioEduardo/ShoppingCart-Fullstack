  ...
  return (
    <main className='min-h-screen bg-Rose-100 flex items-center justify-center px-4'>
      <div className='bg-Rose-50 rounded-2xl p-8 w-full max-w-md shadow-sm'>
        ...
        <h1 className='text-3xl font-bold text-Rose-900 mb-2'>Crear cuenta</h1>
        <p className='text-Rose-500 mb-8'>Regístrate para empezar a ordenar</p>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-1'>
            <label className='text-sm font-semibold text-Rose-900'>Contraseña</label>
            <input
              type='password'
              name='password'
              value={form.password}
